...
func getLogin(tokenString string, log *slog.Logger, er *usecase.AllErr) (string, error) {
...
func GetCookie(log *slog.Logger, r *http.Request, er *usecase.AllErr) (string, error) {
